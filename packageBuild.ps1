...
Copy-Item $env:APPVEYOR_BUILD_FOLDER\VoronoiDiagram\bin\Release\PixelsForGlory.ComputationalSystem.VoronoiDiagram.dll -Destination $destinationFolder -Force 
